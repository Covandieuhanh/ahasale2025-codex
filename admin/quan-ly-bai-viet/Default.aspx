<%@ Page Title="Quản lý bài viết" Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="admin_Default" %>
                        ...
                        <div class="bg-white border bd-transparent admin-fullpage-body admin-route-panel-body pl-4 pl-8-md pr-8-md pr-4">
                            ...
                            <div class="row">
                                <div class="cell-lg-6 pr-4-lg">
                                    <div class="mt-3">
                                        <label class="fg-red fw-600">Menu</label>
                                ...
                                <div class="cell-lg-6 pr-4-lg">
                                    <div class="mt-3">
                                        <label class="fw-600">Phân loại loại bài viết</label>
                                        <div>
                                            <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                                                <asp:ListItem Text="Tin tức" Value="tintuc"></asp:ListItem>
                                    ...
                                    <asp:PlaceHolder ID="PlaceHolder3" runat="server" Visible="false">
                                        ...
                                        <div class="mt-3">
                                            <label class="fw-600">Giá vốn</label>
                                            <asp:TextBox ID="txt_giavon" onfocus="AutoSelect(this)" MaxLength="14" oninput="format_sotien_new(this)" runat="server" data-role="input" Text="0"></asp:TextBox>
                                        </div>
                                        <div class="mt-3">
                                            <label class="fw-600">Thưởng chốt sale</label>
                                            <span class="place-right">
                                                <asp:RadioButton ID="chotsale_phantram" runat="server" Text="%" GroupName="chotsale" Checked="true" />
                                                <asp:RadioButton ID="chotsale_tienmat" runat="server" Text="Tiền" GroupName="chotsale" Checked="false" />
                                            </span>
                                            <asp:TextBox ID="txt_thuong_chotsale" onfocus="AutoSelect(this)" MaxLength="14" oninput="format_sotien_new(this)" runat="server" data-role="input" Text="0"></asp:TextBox>
                                        </div>
                                        <div class="mt-3">
                                            <label class="fw-600">Thưởng bán hàng</label>
                                            <span class="place-right">
                                                <asp:RadioButton ID="banhang_phantram" runat="server" Text="%" GroupName="banhang" Checked="true" />
                                                <asp:RadioButton ID="banhang_tienmat" runat="server" Text="Tiền" GroupName="banhang" Checked="false" />
                                            </span>
                                            <asp:TextBox ID="txt_thuong_banhang" onfocus="AutoSelect(this)" MaxLength="14" oninput="format_sotien_new(this)" runat="server" data-role="input" Text="0"></asp:TextBox>
                                        </div>
                                    </asp:PlaceHolder>
                                </div>
                                <div class="cell-lg-6 pl-4-lg">
                                    <div class="mt-3">
                                        <asp:CheckBox ID="Check_NoiBat" runat="server" Text="Đánh dấu là nổi bật" CssClass="fw-600 fg-cobalt" />
                                    </div>
                                </div>
                                ...
                                <div class="cell-lg-12">
                                    <div class="mt-3">
                                        ...
                                        <CKEditor:CKEditorControl ID="txt_noidung" runat="server" Height="400px" Width="100%" CustomConfig="/ckeditor/config.js"></CKEditor:CKEditorControl>
                                ...
                                <div class="cell-lg-6 pr-4-lg">
                                    <div class="mt-3">
                                        ...
                                        <asp:CheckBoxList ID="check_list_excel" runat="server" AutoPostBack="true" OnSelectedIndexChanged="check_list_excel_SelectedIndexChanged">
                                            ...
                                            <asp:ListItem Text="Tên bài viết" Value="name" Selected="true"></asp:ListItem>
                                            <asp:ListItem Text="Tên menu" Value="TenMenu" Selected="true"></asp:ListItem>
                                            <asp:ListItem Text="Nổi bật" Value="noibat" Selected="true"></asp:ListItem>
                                            <asp:ListItem Text="Phân loại" Value="phanloai" Selected="true"></asp:ListItem>
                            ...
                            <table class="bcorn-fix-title-table">
                                <thead>
                                    <tr class="">
                                        ...
                                        <th class="text-left" style="min-width: 180px;">Tên bài viết</th>
                                        <th class="text-left" style="min-width: 150px">Menu</th>
                                        <th style="width: 70px; min-width: 70px">Nổi bật</th>
                                        <th style="width: 82px; min-width: 82px">Phân loại</th>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <tr>
                                               ...
                                               <%#Eval("name") %>
                                                ...
                                                <td class="text-center">
                                                    <asp:CheckBox ID="CheckBox1" runat="server" onkeypress="if (event.keyCode==13) return false;" />
                                                </td>

                                                <td>
                                                    <asp:PlaceHolder ID="PlaceHolder4" runat="server" Visible='<%#Eval("phanloai").ToString()=="tintuc" %>'>
                                                        <span class="button mini rounded info">Tin tức</span>
                                                    </asp:PlaceHolder>
                                                    <asp:PlaceHolder ID="PlaceHolder5" runat="server" Visible='<%#Eval("phanloai").ToString()=="sanpham" %>'>
                                                        <span class="button mini rounded success">Sản phẩm</span>
                                                    </asp:PlaceHolder>
                                                    <asp:PlaceHolder ID="blaceHolder6" runat="server" Visible='<%#Eval("phanloai").ToString()=="dichvu" %>'>
                                                        <span class="button mini rounded yellow">Dịch vụ</span>
                                                    </asp:PlaceHolder>
                                                </td>
