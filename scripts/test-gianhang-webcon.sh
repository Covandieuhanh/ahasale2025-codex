...
TKCHINHANH="${TKCHINHANH:-admin}"

paths=(
  "/gianhang/webcon/Default.aspx?tkchinhanh=${TKCHINHANH}"
  "/gianhang/webcon/datlich.aspx?tkchinhanh=${TKCHINHANH}"
  "/gianhang/webcon/giohang.aspx?tkchinhanh=${TKCHINHANH}"
)
...
printf "Testing GianHang WebCon endpoints at %s (tkchinhanh=%s)\n" "$BASE_URL" "$TKCHINHANH"
...
echo "GianHang WebCon smoke tests passed."
