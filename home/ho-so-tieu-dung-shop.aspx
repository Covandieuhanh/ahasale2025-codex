<%@ Page Title="Hồ sơ tiêu dùng Gian hàng đối tác" Language="C#" MasterPageFile="~/MasterPage/Tabler/TablerHome.master"
    AutoEventWireup="true" CodeFile="ho-so-tieu-dung-shop.aspx.cs" Inherits="home_lich_su_giao_dich" %>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="card">
                                            <div class="card-body d-flex justify-content-between align-items-center">
                                                <div class="fw-bold">Hồ sơ tiêu dùng Gian hàng đối tác</div>
                ...
                <div class="container-xl">
                    <div class="row g-2 align-items-center">
                        <div class="col">
                            ...
                            <h2 class="page-title">Hồ sơ tiêu dùng Gian hàng đối tác</h2>
                        </div>
                ...
                <div class="container-xl">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-muted">Số dư tiêu dùng ShopOnly</div>
                                    <div class="h2 mb-0">
                                        <asp:Label ID="lb_balance_td" runat="server" Text="0"></asp:Label> A
                                    </div>
                                    <div class="small text-muted">≈ <asp:Label ID="lb_balance_td_vnd" runat="server" Text="0"></asp:Label> đ</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-info">
                        <small>Quyền tiêu dùng là đơn vị quy ước nội bộ được hiển thị và sử dụng trên nền tảng ahasale.vn, đóng vai trò làm phương tiện trao đổi giá trị.
                            <br />
                            Tỷ lệ tham chiếu: 1 Quyền tiêu dùng tương đương 1000 VNĐ (Việt Nam đồng).
                            <br />
                            Lưu ý: Quyền tiêu dùng không phải là tiền tệ hợp pháp và chỉ có hiệu lực trong phạm vi nền tảng.
                        </small>
                    </div>
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col-md-6">
                            <asp:TextBox ID="txt_timkiem1" runat="server" MaxLength="50" CssClass="form-control"
                                placeholder="Nhập từ khóa" AutoPostBack="true" OnTextChanged="txt_timkiem_TextChanged">
                            </asp:TextBox>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-vcenter card-table">
                                ...
                                <tbody>
                                    ...
                                    <asp:PlaceHolder ID="ph_empty_tieudung" runat="server" Visible="false">
                                        <tr>
                                            <td colspan="5" class="text-center text-muted py-4">Chưa có giao dịch tiêu dùng ShopOnly.</td>
                                        </tr>
                                    </asp:PlaceHolder>
                                </tbody>
                            </table>
