<%@ Page Title="Đặt lại mã PIN" Language="C#" MasterPageFile="~/MasterPage/Tabler/TablerHome.master"
    AutoEventWireup="true" CodeFile="dat-lai-ma-pin.aspx.cs" Inherits="home_dat_lai_ma_pin" %>
                    ...
                    <div class="card card-md">
                        <div class="card-body">
                            ...
                            <asp:Panel ID="pn_form" runat="server" Visible="false">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Mã PIN mới (4 chữ số)</label>
                                    <div class="input-group input-group-flat">
                                        <asp:TextBox ID="txt_new_pin" runat="server"
                                            CssClass="form-control js-password"
                                            MaxLength="4"
                                            TextMode="Password"
                                            placeholder="Nhập mã PIN mới"
                                            autocomplete="off"
                                            Attributes="inputmode:numeric;pattern:[0-9]*"></asp:TextBox>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-flat">
                                        <asp:TextBox ID="txt_new_pin_repeat" runat="server"
                                            CssClass="form-control js-password"
                                            MaxLength="4"
                                            TextMode="Password"
