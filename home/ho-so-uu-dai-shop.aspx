                ...
                <div class="container-xl">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-muted">Số dư ưu đãi ShopOnly</div>
                                    <div class="h2 mb-0">
                                        <asp:Label ID="lb_balance_ud" runat="server" Text="0"></asp:Label> A
                                    </div>
                                    <div class="small text-muted">≈ <asp:Label ID="lb_balance_ud_vnd" runat="server" Text="0"></asp:Label> đ</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-vcenter card-table">
                                ...
                                <tbody>
                                    ...
                                    <asp:PlaceHolder ID="ph_empty_uudai" runat="server" Visible="false">
                                        <tr>
                                            <td colspan="5" class="text-center text-muted py-4">Chưa có giao dịch ưu đãi ShopOnly.</td>
                                        </tr>
                                    </asp:PlaceHolder>
                                </tbody>
                            </table>
