<%@ Page Language="C#" AutoEventWireup="true" CodeFile="khoi-phuc-ma-pin.aspx.cs" Inherits="admin_khoi_phuc_mat_khau" %>
                    ...
                    <div>
                        <asp:PlaceHolder ID="PlaceHolder1" runat="server">
                            <div class="text-center fg-white">
                                ...
                                <div class="mt-3"><a href="/" class="button small dark rounded">Quay lại trang chủ</a></div>
                            </div>
                                ...
                                <asp:Panel ID="Panel1" runat="server" DefaultButton="Button1">
                                    ...
                                    <div class="mt-5">
                                        <div style="float: left">
                                            <small><a href="/" class="fg-white fg-black-hover">Quay lại trang chủ</a></small>
                                        </div>
                                        <div style="float: right">
                                            <asp:Button ID="Button1" runat="server" Text="ĐẶT LẠI MÃ PIN" CssClass="button dark ml-2 " OnClick="Button1_Click" />
                                        </div>
