<%@ Page Title="Khôi phục mã PIN" Language="C#" MasterPageFile="~/MasterPage/Tabler/TablerHome.master"
    AutoEventWireup="true" CodeFile="khoi-phuc-ma-pin.aspx.cs" Inherits="home_khoi_phuc_ma_pin" %>
            ...
            <div class="page page-center">
                <div class="container container-tight py-4">
                    <div class="card card-md">
                        <div class="card-body">
                            <h2 class="h2 text-center mb-4">Khôi phục mã PIN</h2>
