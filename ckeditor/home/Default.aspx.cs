...
public partial class home_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            using (dbDataContext db = new dbDataContext())
            {
                ...
                {
                    string targetPublic = "/shop/public.aspx?user=" + HttpUtility.UrlEncode(q_tk.taikhoan);
    ...
    {
        return !string.IsNullOrEmpty(ResolveSocialIcon(icon));
    }
    ...
    {
        return ResolveImageOrFallback(imageRaw, "");
    }
