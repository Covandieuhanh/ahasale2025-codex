...
public partial class home_login : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (ph_switch_home_mode != null)
            ph_switch_home_mode.Visible = (!PortalActiveMode_cl.IsHomeActive() && PortalActiveMode_cl.HasHomeCredential());
        ...
        if (!IsPostBack)
        {
            ...
            if (taikhoan_cl.exist_taikhoan(_tk))
            {
                ...
                using (dbDataContext db = new dbDataContext())
                {
                    ...
                    if (canLoginHome && PortalActiveMode_cl.IsHomeActive())
                    {
