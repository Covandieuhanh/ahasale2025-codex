...
public partial class admin_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        but_show_form_add.Visible = CanCreateAdminAccountInCurrentScope();
    ...
    {
        return IsRootAdminCurrent() && IsAdminAccountManagementScope();
    }
    ...
    private void ShowAddForm()
    {
        ...
        {
            Session["thongbao"] = thongbao_class.metro_notifi_onload("Thông báo", "Chỉ tài khoản admin gốc trong tab quản lý tài khoản admin mới được tạo tài khoản admin.", "1000", "warning");
            Response.Redirect(BuildListUrl(), false);
            Context.ApplicationInstance.CompleteRequest();
            return;
        }
        ...
        try
        {
            ...
            if (!CanCreateAdminAccountInCurrentScope())
            {
                ScriptManager.RegisterStartupScript(this.Page, this.GetType(), Guid.NewGuid().ToString(),
                    thongbao_class.metro_dialog("Thông báo", "Chỉ tài khoản admin gốc trong tab quản lý tài khoản admin mới được tạo tài khoản admin.", "false", "false", "OK", "alert", ""), true);
                return;
            }
