...
public partial class admin_Default : System.Web.UI.Page
{
    ...
    {
        return ResolveUrl("~/admin/quan-ly-menu/default.aspx");
    }
        ...
        try
        {
            ...
            using (dbDataContext db = new dbDataContext())
            {
                if (ViewState["add_edit"].ToString() == "add")
                {
                    ...
                    if (_name == "")
                    {
                        ScriptManager.RegisterStartupScript(this.Page, this.GetType(), Guid.NewGuid().ToString(), thongbao_class.metro_dialog("Thông báo", "Vui lòng nhập tên Menu.", "false", "false", "OK", "alert", ""), true);
                        return;
                    }
                    else
                    {
