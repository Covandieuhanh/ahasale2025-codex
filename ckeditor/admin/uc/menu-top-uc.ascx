...
<div data-role="appbar" class="fg-white bg-nmenutop-bc admin-topbar" data-expand-point="lg" style="position: fixed; top: 0; z-index: 3">
    ...
    <a class="app-bar-item fg-white admin-topbar-home" href="/admin/default.aspx"><span class="mif mif-home"></span></a>
    <a class="app-bar-item fg-white d-block-lg d-none fw-600 admin-topbar-title" style="z-index: 10!important" href="/admin/default.aspx"><%=ViewState["title"] %></a>
