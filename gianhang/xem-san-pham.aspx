        ...
        <div class="shell">
                ...
                <div class="card">
                    ...
                    <div class="layout">
                        ...
                        <div>
                            ...
                            <div class="actions">
                                <asp:HyperLink ID="lnk_exchange" runat="server" CssClass="btn btn-primary">Trao đổi</asp:HyperLink>
                                <asp:HyperLink ID="lnk_cart" runat="server" CssClass="btn btn-soft">Thêm vào giỏ</asp:HyperLink>
                            </div>
                        </div>
                    </div>
                    <div class="content">
            ...
            <asp:PlaceHolder ID="pn_not_found" runat="server" Visible="false">
                <div class="card not-found">
                    ...
                    <p>Sản phẩm này hiện không còn hiển thị hoặc đã được gỡ khỏi gian hàng.</p>
