<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xem-san-pham.aspx.cs" Inherits="gianhang_xem_san_pham" %>
        ...
        <div class="shell">
            <asp:PlaceHolder ID="pn_content" runat="server" Visible="false">
                <div class="card">
                    ...
                    <div class="layout">
                        <div>
                            <asp:Image ID="img_product" runat="server" CssClass="image" />
                        </div>
                        <div>
                            ...
                            <div class="trust-strip">
                                ...
                                <span class="trust-pill">Trao Ä‘á»•i trá»±c tiáº¿p báº±ng tÃ i khoáº£n AhaSale</span>
                            </div>
                            <div class="stats">
                            ...
                            <div class="actions">
                                <asp:HyperLink ID="lnk_exchange" runat="server" CssClass="btn btn-primary">Trao Ä‘á»•i</asp:HyperLink>
                                <asp:HyperLink ID="lnk_cart" runat="server" CssClass="btn btn-soft">ThÃªm vÃ o giá»</asp:HyperLink>
                            </div>
                        </div>
                    </div>
                    <div class="content">
            ...
            <asp:PlaceHolder ID="pn_not_found" runat="server" Visible="false">
                <div class="card not-found">
                    ...
                    <p>Sáº£n pháº©m nÃ y hiá»‡n khÃ´ng cÃ²n hiá»ƒn thá»‹ hoáº·c Ä‘Ã£ Ä‘Æ°á»£c gá»¡ khá»i gian hÃ ng.</p>
