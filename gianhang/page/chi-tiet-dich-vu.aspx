        ...
        <div class="gh-detail-shell">
            <div class="gh-detail-card">
                <div class="gh-detail-hero">
                    <div class="gh-detail-kicker">Dịch vụ công khai</div>
                ...
                <div class="gh-detail-layout">
                    ...
                    <div class="gh-detail-panel">
                        <div class="gh-detail-trust">
                            <span class="gh-pill">Có thể đặt lịch trực tiếp</span>
                            <span class="gh-pill">Hiển thị công khai trong gian hàng</span>
                        </div>
                        <div class="gh-detail-price">Giá dịch vụ: <%=gia %> VNĐ</div>
                        <div class="gh-detail-meta mt-4">
                            <span class="gh-meta-chip">Dịch vụ này sẵn sàng nhận lịch hẹn</span>
                            <span class="gh-meta-chip">Xem thêm các dịch vụ liên quan phía dưới</span>
                        </div>
