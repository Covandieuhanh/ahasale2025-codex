                    ...
                    <div style="border-top: 1px solid #eeeeee" class="mt-9">
                        ...
                        <asp:Repeater ID="Repeater2" runat="server">
                            <ItemTemplate>
                                <div class="row mt-9">
                                    <div class="cell-lg-4">
                                        <a href="/gianhang/page/chi-tiet-bai-viet.aspx?idbv=<%#Eval("id") %>">
                                            <img src="<%#Eval("image") %>" class="radius-bc-4" /></a>
                                    </div>
                                    <div class="cell-lg-8 pl-3-lg">
                                        <div class="fw-600 ellipsis-2 mt-0-lg mt-2">
                                            <a class="fg-black fg-emerald-hover" href="/gianhang/page/chi-tiet-bai-viet.aspx?idbv=<%#Eval("id") %>"><%#Eval("name") %></a>
                                        </div>
