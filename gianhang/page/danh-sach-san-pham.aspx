<%@ Page Title="" Language="C#" MasterPageFile="~/gianhang/mp-home.master" AutoEventWireup="true" CodeFile="danh-sach-san-pham.aspx.cs" Inherits="danh_sach_bai_viet" %>
            ...
            <div class="gh-list-shell">
                <div class="gh-list-wrap">
                    <div class="gh-list-hero">
                        <div class="gh-list-kicker">Sản phẩm công khai</div>
                            ...
                            <ItemTemplate>
                                <div class="gh-list-card">
                                    ...
                                    <div class="gh-list-card-body">
                                        ...
                                        <div class="gh-list-card-price"><%#Eval("giaban","{0:#,##0}") %> VNĐ</div>
                                        <div class="gh-list-card-actions">
                                            <a class="gh-btn-soft" href='<%# BuildCartUrl(Eval("id")) %>'>Thêm vào giỏ</a>
                                            <a class="gh-btn-primary" href='<%# BuildCheckoutUrl(Eval("id")) %>'>Đặt hàng</a>
                                        </div>
                                    </div>
                                </div>
                            </ItemTemplate>
