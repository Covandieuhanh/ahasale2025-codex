...
public partial class uc_dangnhap_uc : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //    {
        //        bspa_data_khachhang_table _ob = t;
        //        _ob.matkhau = encode_class.encode_md5(encode_class.encode_sha1("12345678"));
        //        db.SubmitChanges();
        //    }
        //}
    }
    protected void but_login_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    bspa_data_khachhang_table _ob = kh_cl.return_object_sdt_cnaka(_sdt);
                    if (_ob.id_chinhanh == AhaShineContext_cl.ResolveChiNhanhId())//chi nhánh aka
                    {
                        ...
                        if (_ob.matkhau == _pass_mahoa)
                        {
                            ...
                            app_cookie_policy_class.persist_cookie(
                                HttpContext.Current,
                                app_cookie_policy_class.home_user_cookie,
                            ...
                            app_cookie_policy_class.persist_cookie(
                                HttpContext.Current,
                                app_cookie_policy_class.home_pass_cookie,
                                _pass_mahoa,
                                365
                            );

                            Session["user_home"] = _sdt;
