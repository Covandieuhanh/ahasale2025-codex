            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <article class="article-lead">
                        <a class="article-lead__media" href="<%# BuildArticleUrl(Eval("id")) %>" data-fallback="Hinh anh dang cap nhat">
                        ...
                        <div class="article-lead__body">
                            ...
                            <div class="service-card__actions">
                                ...
                                <a class="service-card__button service-card__button--primary" href="<%# BuildArticleUrl(Eval("id")) %>"><%=PrimaryButtonText %></a>
                                <% } %>
                            </div>
                        </div>
                    </article>
                ...
                <asp:Repeater ID="Repeater2" runat="server">
                    <ItemTemplate>
                        <article class="article-mini">
                            <a class="article-mini__media" href="<%# BuildArticleUrl(Eval("id")) %>" data-fallback="Hinh anh dang cap nhat">
