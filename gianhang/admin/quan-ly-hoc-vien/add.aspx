<%@ Page Title="Thêm thành viên" Language="C#" MasterPageFile="~/gianhang/admin/mp-admin.master" AutoEventWireup="true" CodeFile="add.aspx.cs" Inherits="taikhoan_add" %><asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
            ...
            <div class="cell-6">
                <ul class="h-menu">
                    <li data-role="hint" data-hint-position="top" data-hint-text="Quay lại">
                        <a class="button" href="/gianhang/admin/quan-ly-hoc-vien/Default.aspx"><span class="mif mif-arrow-left"></span></a></li>
            ...
            <div class="cell-12">
                <asp:Panel ID="Panel1" runat="server" DefaultButton="button1">
                            ...
                            <div class="mt-3">
                                ...
                                <div class="mt-2 p-3 border bd-cyan bg-light" style="border-radius: 14px;">
                                    ...
                                    <div class="mt-1 fg-gray">
                                        Nếu thành viên này có số điện thoại, sau khi lưu hệ thống sẽ tự gom vào module <strong>Hồ sơ người</strong>. Việc liên kết tài khoản Home được làm ở đó để mọi vai trò cùng số điện thoại dùng chung một định danh.
                                    </div>
                                </div>
                            </div>
                            <div class="mt-3">
                    ...
                    <div class="text-center mt-10">
                        <asp:Button OnClientClick="Metro.activity.open({type:'cycle',overlayClickClose:false})" ID="button1" runat="server" Text="THÊM thành viên" CssClass="button success" OnClick="button1_Click1" />
                    </div>
                </asp:Panel>
            </div>
        </div>
