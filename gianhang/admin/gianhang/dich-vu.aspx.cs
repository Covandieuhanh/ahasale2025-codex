...
public partial class gianhang_admin_gianhang_dich_vu : System.Web.UI.Page
{
    ...
    public string CompanionUrl = "/gianhang/admin/gianhang/san-pham.aspx";
    public string PublicListUrl = "/gianhang/page/danh-sach-dich-vu.aspx";
    public string AdminLegacyUrl = "/gianhang/admin/quan-ly-bai-viet/Default.aspx?pl=dv";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        CompanionUrl = GianHangRoutes_cl.BuildAdminWorkspaceProductsUrl();
        PublicListUrl = GianHangRoutes_cl.BuildServicesUrl(ownerAccountKey);
        AdminLegacyUrl = "/gianhang/admin/quan-ly-bai-viet/Default.aspx?pl=dv";
    ...
    {
        string baseUrl = GianHangRoutes_cl.BuildAdminWorkspaceServicesUrl();
        if (clear)
            return baseUrl;
