...
public partial class taikhoan_add : System.Web.UI.Page
{
    ...
    public void main()
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (HasAnyPermission("q15_3"))//neu la quyen cap chi nhanh
            {
    ...
    protected void button1_Click1(object sender, EventArgs e)
    {
        if (!HasAnyPermission("q15_3", "n15_3"))
        {
            notifi = thongbao_class.metro_dialog_onload("Thông báo", "Bạn không đủ quyền để cập nhật chuyên gia.", "false", "false", "OK", "alert", "");
            return;
        }
    ...
    protected void Button2_Click(object sender, EventArgs e)//xóa ảnh đại diện
    {
        if (!HasAnyPermission("q15_3", "n15_3"))
        {
            notifi = thongbao_class.metro_dialog_onload("Thông báo", "Bạn không đủ quyền để xóa ảnh đại diện chuyên gia.", "false", "false", "OK", "alert", "");
            return;
        }
    ...
    protected void but_ngung_giangday_Click(object sender, EventArgs e)
    {
        if (!HasAnyPermission("q15_3", "n15_3"))
        {
            notifi = thongbao_class.metro_dialog_onload("Thông báo", "Bạn không đủ quyền để ngừng giảng dạy chuyên gia.", "false", "false", "OK", "alert", "");
            return;
        }
    ...
    protected void but_molai_giangday_Click(object sender, EventArgs e)
    {
        if (!HasAnyPermission("q15_3", "n15_3"))
        {
            notifi = thongbao_class.metro_dialog_onload("Thông báo", "Bạn không đủ quyền để mở lại chuyên gia.", "false", "false", "OK", "alert", "");
            return;
        }
