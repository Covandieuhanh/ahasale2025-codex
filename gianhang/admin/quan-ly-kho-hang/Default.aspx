<%@ Page Title="Kho" Language="C#" MasterPageFile="~/gianhang/admin/mp-admin.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="badmin_quan_ly_menu_Default" %>
                        ...
                        <div id="_sort">
                            <div class="mt-3">
                                ...
                                <asp:DropDownList ID="DropDownList2" runat="server" data-role="select" data-filter="false">
                                    ...
                                    <asp:ListItem Text="Hạn sử dụng (Sắp hết lên trước)" Value="2"></asp:ListItem>
                                    <asp:ListItem Text="Hạn sử dụng (Lâu hết lên trước)" Value="3"></asp:ListItem>
                        ...
                        <div class="place-right">
                            <ul class="h-menu">
                                <li data-role="hint" data-hint-position="top" data-hint-text="Nhập hàng">
                                    <a class="button" href="/gianhang/admin/quan-ly-kho-hang/nhap-hang.aspx"><span class="mif mif-plus"></span></a></li>
                        ...
                        <table class="table row-hover table-border cell-border compact normal-lg <%--striped--%> <%--compact normal-lg--%>">
                            <thead>
                                <tr style="background-color: #f5f5f5">
                                    ...
                                    <td class=" text-bold " style="min-width: 200px">Tên sản phẩm</td>
                                    ...
                                    <td style="width: 1px;" class=" text-bold text-center">Ngày sản xuất</td>
                                    <td style="width: 1px;" class=" text-bold text-center">Hạn sử dụng</td>
                            ...
                            <tbody>
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                                <%#Eval("ngaynhap","{0:dd/MM/yyyy}").ToString() %>
                                            </td>
