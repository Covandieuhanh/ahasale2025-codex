<%@ Page Title="Chi tiết nhập hàng" Language="C#" MasterPageFile="~/gianhang/admin/mp-admin.master" AutoEventWireup="true" CodeFile="chi-tiet-nhap-hang.aspx.cs" Inherits="badmin_Default" %><asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <style>
        .info-hoadon {
            font-weight: 600
        }
                            ...
                            <ContentTemplate>
                                <asp:Panel ID="Panel2" runat="server" DefaultButton="but_form_themsanpham">
                                    <div class="row ">
                                        ...
                                        <div class="cell-lg-6 mt-3 pl-3-md pr-3-md pl-0 pr-0">
                                            <div>
                                                <label class="fw-600">Ngày sản xuất</label>
                                    ...
                                    <div class="mt-6 mb-6 text-right">
                                        ...
                                        <div style="float: right">
                                            <asp:Button ID="but_form_themsanpham" runat="server" Text="NHẬP THÊM HÀNG" CssClass="button success" OnClick="but_form_themsanpham_Click" />
                                        </div>
                                        <div style="clear: both"></div>
                                    </div>
                                </asp:Panel>
            ...
            <ContentTemplate>
                ...
                <div class="row">
                    <div class="cell-lg-6 pr-3-lg mt-3">
                        <div data-role="panel"
                            data-title-caption="Mã đơn nhập hàng: <b><%=id %></b>"
                            data-title-icon="<a data-role='hint' data-hint-position='top' data-hint-text='Quay lại' href='/gianhang/admin/quan-ly-kho-hang/don-nhap-hang.aspx'><span class='mif-arrow-left'></span></a>"
                ...
                <div>
                    <h5 class="pt-10">Chi tiết đơn nhập hàng</h5>
                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/gianhang/admin/quan-ly-kho-hang/edit-cthd.aspx?id=<%#Eval("id") %>" data-role='hint' data-hint-position='top' data-hint-text='Nhấn để sửa'>
