<%@ Page Title="Quản lý ngành" Language="C#" MasterPageFile="~/gianhang/admin/mp-admin.master" AutoEventWireup="true" CodeFile="nganh.aspx.cs" Inherits="badmin_Default" %>
                            ...
                            <table class="table row-hover <%--table-border cell-border--%> <%--striped--%> <%--compact--%>">
                                <tbody>
                                    <tr style="background-color: #ecf0f5">
                                        ...
                                        <td class="text-bold" style="min-width: 350px">Tên ngành</td>
                                    </tr>
