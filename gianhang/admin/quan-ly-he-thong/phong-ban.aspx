<%@ Page Title="Quản lý phòng ban" Language="C#" MasterPageFile="~/gianhang/admin/mp-admin.master" AutoEventWireup="true" CodeFile="phong-ban.aspx.cs" Inherits="badmin_Default" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="but_form_themnhomthuchi">
                            <div class="mt-3">
                                <asp:TextBox ID="txt_tennhom" runat="server" data-role="input" placeholder="Nhập tên phòng ban"></asp:TextBox><%--autocomplete="off" --%>
                            </div>
                            ...
                            <table class="table row-hover <%--table-border cell-border--%> <%--striped--%> <%--compact--%>">
                                <tbody>
                                    <tr style="background-color: #ecf0f5">
                                        ...
                                        <td class="text-bold" style="min-width: 350px">Tên phòng ban</td>
                                    </tr>
