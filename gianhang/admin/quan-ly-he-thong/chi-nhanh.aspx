<%@ Page Title="Quản lý chi nhánh" Language="C#" MasterPageFile="~/gianhang/admin/mp-admin.master" AutoEventWireup="true" CodeFile="chi-nhanh.aspx.cs" Inherits="badmin_Default" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="but_form_themnhomthuchi">
                            <div class="mt-3">
                                <asp:TextBox ID="txt_tennhom" runat="server" data-role="input" placeholder="Nhập tên chi nhánh"></asp:TextBox><%--autocomplete="off" --%>
                            </div>
                                ...
                                <tbody>
                                    <tr style="background-color: #ecf0f5">
                                        ...
                                        <td style="width: 1px;">
                                         ...
                                         <td class="text-bold" style="width: 1px;">Mã</td>
                                        <td class="text-bold" style="min-width: 350px">Tên chi nhánh</td>
                                        <td class="text-bold" style="min-width: 150px">Tài khoản quản trị</td>
                                    </tr>
                                    <asp:Repeater ID="Repeater1" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class="text-bold">
                                                    <a href="/gianhang/admin/quan-ly-he-thong/edit-chi-nhanh.aspx?id=<%#Eval("id") %>" data-role="hint" data-hint-position="top" data-hint-text="Chỉnh sửa">
                                                    CN_<%#Eval("id") %>
                                                    </a>
                                                </td>
                                                <td>
                                                    <input data-role="input" data-clear-button="false" name="name_<%#Eval("id").ToString() %>" type="text" value="<%#Eval("ten").ToString() %>" onkeypress="if (event.keyCode==13) return false;" autocomplete="off" /></td>
                                                <td><%#Eval("taikhoan_quantri") %></td>
                                            </tr>
                                            <%--<%stt = stt + 1; %>--%>
                                        </ItemTemplate>
                                    </asp:Repeater>
