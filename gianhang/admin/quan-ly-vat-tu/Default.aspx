<%@ Page Title="Quản lý vật tư" Language="C#" MasterPageFile="~/gianhang/admin/mp-admin.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="badmin_quan_ly_menu_Default" %>
                ...
                <asp:Panel ID="Panel1" runat="server" DefaultButton="Button1">
                    ...
                    <div class="">
                        <div id="_data">
                            ...
                            <div class="mt-3">
                                <div class="fw-600">Nhóm</div>
                                <asp:DropDownList ID="ddl_loc1" runat="server" data-role="select" data-filter="false"></asp:DropDownList>
                            </div>
                            <div class="mt-3">
                                <div class="fw-600">Nhà cung cấp</div>
                                <asp:DropDownList ID="ddl_loc2" runat="server" data-role="select" data-filter="false"></asp:DropDownList>
                            </div>
                            <div class="mt-3">
                                <div class="fw-600">Phòng ban</div>
                                <asp:DropDownList ID="ddl_loc3" runat="server" data-role="select" data-filter="false"></asp:DropDownList>
                            </div>
                        </div>
                        <div id="_time">
                        ...
                        <div class="place-right">
                            <ul class="h-menu">
                                <li data-role="hint" data-hint-position="top" data-hint-text="Thêm">
                                    <a class="button" href="/gianhang/admin/quan-ly-vat-tu/add.aspx"><span class="mif mif-plus"></span></a></li>
                        ...
                        <table class="table row-hover table-border cell-border compact normal-lg <%--striped--%> <%--compact normal-lg--%>">
                            <thead>
                                <tr style="background-color: #f5f5f5">
                                    ...
                                    <td class=" text-bold " style="min-width: 150px">Tên vật tư</td>
                                    <td class=" text-bold" style="min-width: 100px">Nhóm</td>
                                    <td class=" text-bold" style="min-width: 120px">Nhà cung cấp</td>
                                    <td class=" text-bold" style="min-width: 120px">Giá bán</td>
                                    <td class=" text-bold" style="min-width: 120px">Giá nhập</td>
                                    <td class=" text-bold" style="width: 1px">ĐVT</td>
                                    <td class=" text-bold" style="min-width: 100px">Tình trạng</td>
                                    <td class=" text-bold" style="min-width: 120px">Phòng ban</td>
                                ...
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="text-center text-bold"><a href="/gianhang/admin/quan-ly-vat-tu/edit.aspx?id=<%#Eval("id") %>" data-role="hint" data-hint-position="right" data-hint-text="Nhấn để sửa"><%#Eval("id") %></a></td>
                                            <td>
                                                <a href="/gianhang/admin/quan-ly-vat-tu/edit.aspx?id=<%#Eval("id") %>">

                                                    <img src="<%#Eval("image") %>" class="img-cover-vuong w-h-50" style="max-width: none!important">
                                                </a>
                                            </td>
                                            <td>
                                                <a href="/gianhang/admin/quan-ly-vat-tu/edit.aspx?id=<%#Eval("id") %>" class="fg-black">
                                                    <span><%#Eval("name") %></span>
                                                </a>
                                            </td>
                                            <td><%#Eval("tenmn") %></td>
                                            ...
                                            <td class="text-right">
                                                <div><%#Eval("giavon_sp","{0:#,##0}").ToString() %></div>
                                            </td>
                                            <td class="text-center">
                                                <div><%#Eval("dvt_sp","{0:#,##0}").ToString() %></div>
                                            </td>
                                            <td><%#Eval("tinhtrang") %>
                                            ...
                                            <td class="text-right">
                                                <small><%#Eval("ngaytao","{0:dd/MM/yyyy}").ToString() %>
                                                    <div><%#Eval("nguoitao").ToString() %></div>
                                                </small>
                                            </td>
                                        </tr>
