<%@ Page Title="Thêm vật tư" Language="C#" MasterPageFile="~/gianhang/admin/mp-admin.master" AutoEventWireup="true" CodeFile="add.aspx.cs" Inherits="badmin_temp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="Server">
    <%if (bcorn_class.check_quyen(user, "q11_7") == "")
        { %>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Panel ID="Panel2" runat="server" DefaultButton="but_form_themnhomthuchi">
                            <div class="mt-3">
                                <asp:TextBox ID="txt_tennhom" runat="server" data-role="input" placeholder="Nhập tên nhà cung cấp"></asp:TextBox><%--autocomplete="off" --%>
                            </div>
    ...
    <div id="main-content" class=" mb-10">
        ...
        <asp:Panel ID="Panel1" runat="server" DefaultButton="button1">
                ...
                <div class="cell-lg-6 pl-2-lg pr-2-lg mt-3">
                    ...
                    <div class="place-right">
                        <a class=" fg-red fg-orange-hover" href="#" onclick="show_hide_id_form_2()"><small>Thêm nhanh</small></a>/ 
                            <a class=" fg-red fg-orange-hover" href="/gianhang/admin/quan-ly-kho-hang/nha-cung-cap.aspx"><small>Quản lý</small></a>
                    </div>
            ...
            <div class="text-center mt-10">
                <asp:Button ID="button1" runat="server" Text="THÊM VẬT TƯ" CssClass="button success" OnClientClick="Metro.activity.open({type:'cycle',overlayClickClose:false})" OnClick="button1_Click" />
            </div>
        </asp:Panel>
    </div>
</asp:Content>
