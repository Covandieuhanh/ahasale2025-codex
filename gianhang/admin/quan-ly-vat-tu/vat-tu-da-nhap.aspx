<%@ Page Title="Đơn nhập vật tư" Language="C#" MasterPageFile="~/gianhang/admin/mp-admin.master" AutoEventWireup="true" CodeFile="vat-tu-da-nhap.aspx.cs" Inherits="badmin_Default" %><asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <style>
        .icon-box {
                ...
                <div class="row mt-1-minus <%--mt-0-lg-minus mt-12-minus--%>">
                    ...
                    <div class="cell-md-6 order-1 order-md-2 mt-0">
                        <div class="place-right">
                            <ul class="h-menu">
                                <%if (bcorn_class.check_quyen(user, "q13_2") == "")
                                    { %>
                                <li data-role="hint" data-hint-position="top" data-hint-text="Nhập hàng">
                                    <a class="button" href="/gianhang/admin/quan-ly-vat-tu/nhap-vat-tu.aspx?q=nh"><span class="mif mif-plus"></span></a></li>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                               <a  data-role="hint" data-hint-position="top" data-hint-text="Xem chi tiết" href="/gianhang/admin/quan-ly-vat-tu/chi-tiet-nhap-hang.aspx?id=<%#Eval("id").ToString() %>">
