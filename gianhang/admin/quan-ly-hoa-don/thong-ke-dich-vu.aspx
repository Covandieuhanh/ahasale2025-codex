<%@ Page Title="Thống kê dịch vụ" Language="C#" MasterPageFile="~/gianhang/admin/mp-admin.master" AutoEventWireup="true" CodeFile="thong-ke-dich-vu.aspx.cs" Inherits="badmin_Default" %>
            ...
            <ContentTemplate>
                ...
                <div class="report-kpi">
                    <div class="report-kpi__card">
                        <small>Doanh thu dịch vụ (sau CK)</small>
                        ...
                        <table class="table row-hover table-border cell-border compact normal-lg <%--striped--%> <%--compact normal-lg--%>">
                            <thead>
                                <tr style="background-color: #f5f5f5">
                                    <td class="text-bold" style="min-width: 110px;">Tên dịch vụ</td>
                                    <td class="text-bold" style="width: 100px; min-width: 100px">Số lượng</td>
