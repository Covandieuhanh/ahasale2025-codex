<%@ Page Title="" Language="C#" MasterPageFile="~/gianhang/webcon/mp-webcon.master" AutoEventWireup="true" CodeFile="danh-sach-bai-viet.aspx.cs" Inherits="danh_sach_bai_viet" %>
                        ...
                        <asp:Repeater ID="Repeater1" runat="server">
                            <ItemTemplate>
                                <div class="cell-lg-4 pl-3-lg pl-0 pr-3-lg pr-0 mt-10">
                                    <div class="h-100">
                                        <div>
                                            <a class="fg-black fg-green-hover" href="/gianhang/webcon/chi-tiet-bai-viet.aspx?tkchinhanh=<%=tkchinhanh %>&idbv=<%#Eval("id") %>">
                                                <img src="<%#Eval("image") %>" /></a>
                                        </div>
                                        <div class=" border bd-default border-top-none p-3">
                                            <div class=" fw-600 ellipsis-2">
                                                <a class="fg-black fg-green-hover" href="/gianhang/webcon/chi-tiet-bai-viet.aspx?tkchinhanh=<%=tkchinhanh %>&idbv=<%#Eval("id") %>"><%#Eval("name") %></a>
                                            </div>
                                           ...
                                           <hr class="mt-3 mb-3" />
                                            <div class="text-right">
                                                <a href="/gianhang/webcon/chi-tiet-bai-viet.aspx?tkchinhanh=<%=tkchinhanh %>&idbv=<%#Eval("id") %>" class="button secondary rounded">Xem thêm</a>
