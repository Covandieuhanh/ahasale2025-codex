<%@ Page Title="Hồ sơ quyền ưu đãi gian hàng" Language="C#" MasterPageFile="~/MasterPage/Tabler/TablerGianHang.master" AutoEventWireup="true" CodeFile="ho-so-uu-dai.aspx.cs" Inherits="gianhang_ho_so_uu_dai" %>
            ...
            <section class="gh-wallet-hero">
                <div class="gh-wallet-hero-top">
                    <div>
                        ...
                        <h1>Hồ sơ quyền ưu đãi</h1>
                        <p>Đây là hồ sơ nhận quyền riêng của không gian gian hàng, chỉ cộng từ các đơn bán có phần ưu đãi được trao đổi thành công từ tin do chính gian hàng đăng tải.</p>
                    </div>
                ...
                <div class="gh-wallet-hero-bottom">
                    <div class="gh-wallet-stat">
                        ...
                        <div class="gh-wallet-stat-sub">Tổng quyền ưu đãi của riêng gian hàng</div>
                    </div>
                    <div class="gh-wallet-stat">
                ...
                <div class="gh-wallet-card-body">
                    ...
                    <div class="gh-wallet-list" style="margin-top:16px;">
                        ...
                        <asp:PlaceHolder ID="ph_empty" runat="server" Visible="false">
                            <div class="gh-wallet-empty">Chưa có giao dịch quyền ưu đãi nào cho gian hàng này.</div>
                        </asp:PlaceHolder>
                    </div>
