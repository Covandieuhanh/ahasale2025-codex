...
<head runat="server">
    ...
    <title>AhaSale App UI - Quản lý tin đã lưu</title>
        ...
        <div class="app-shell" data-app-density="compact" data-app-shell="home" data-app-nav-active="home">
            <header class="app-topbar">
                ...
                <div class="app-topbar-row">
                    ...
                    <div class="app-search-pill"><span class="app-search-icon"></span><span class="app-search-placeholder">Quản lý đã lưu</span></div>
            ...
            <main class="app-main">
                <section class="app-section" data-app-capability="show_home_saved">
                    <div class="app-home-panel">
                        <span class="app-home-panel-kicker">Kho đã lưu</span>
                        <h1 class="app-home-panel-title">Quản lý các tin bạn đã lưu trong luồng app</h1>
                        <p class="app-home-panel-copy">Màn quản lý tập trung để chuẩn bị cho các thao tác lọc, gỡ lưu và đồng bộ danh sách theo tài khoản.</p>
                    </div>
                </section>
                ...
                <section class="app-section" data-app-capability="show_home_saved">
                    <div class="app-section-head">
                        <div>
                            <h2 class="app-section-title">Danh sách theo dõi</h2>
                            <p class="app-section-subtitle" data-role="saved-summary"></p>
                        </div>
                        <a class="app-ghost-btn" href="/app-ui/home/saved.aspx?ui_mode=app">Về bản xem nhanh</a>
                    </div>
            ...
            <nav class="app-bottom-nav" aria-label="Điều hướng chính" data-app-capability="show_home_saved">
                ...
                <a class="app-bottom-item is-active" href="/app-ui/home/saved-manager.aspx?ui_mode=app">
                ...
                <a class="app-bottom-item" href="/app-ui/home/exchange.aspx?ui_mode=app">
