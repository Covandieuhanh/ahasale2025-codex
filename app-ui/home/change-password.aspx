...
<head runat="server">
    ...
    <title>AhaSale App UI - Đổi mật khẩu tài khoản</title>
            ...
            <main class="app-main">
                <section class="app-page-wrap">
                    <article class="app-page-hero">
                        <span class="app-page-kicker">Home Security</span>
                        <h1 class="app-page-title">Đổi mật khẩu tài khoản</h1>
                        <p class="app-page-copy">Cập nhật mật khẩu để tăng bảo mật tài khoản.</p>
