...
<head runat="server">
    ...
    <title>AhaSale App UI - Lịch sử trao đổi</title>
            ...
            <main class="app-main">
                <section class="app-page-wrap">
                    <article class="app-page-hero">
                        ...
                        <h1 class="app-page-title">Lịch sử trao đổi</h1>
                        <p class="app-page-copy">Xem lịch sử trao đổi và tương tác đã phát sinh.</p>
