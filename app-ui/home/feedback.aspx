...
<head runat="server">
    ...
    <title>AhaSale App UI - Đóng góp ý kiến</title>
            ...
            <main class="app-main">
                <section class="app-page-wrap">
                    <article class="app-page-hero">
                        <span class="app-page-kicker">Home Feedback</span>
                        <h1 class="app-page-title">Đóng góp ý kiến</h1>
                        <p class="app-page-copy">Gửi góp ý để cải thiện trải nghiệm nền tảng.</p>
