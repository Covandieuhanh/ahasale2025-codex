...
<head runat="server">
    ...
    <title>AhaSale App UI - Hồ sơ hành vi lao động</title>
...
<body class="app-ui app-ui-home">
    <form id="form1" runat="server">
        <div class="app-shell" data-app-density="compact" data-app-shell="home" data-app-nav-active="account">
            <main class="app-main">
                <section class="app-page-wrap app-benefit-page" data-app-benefit-page="1" data-benefit-profile="labor">
                    <article class="app-page-hero app-benefit-hero">
                        <div class="app-benefit-hero-grid">
                            <div class="app-benefit-hero-copy">
                                ...
                                <h1 class="app-page-title" data-benefit-title="1">Hồ sơ hành vi lao động</h1>
                                <p class="app-page-copy" data-benefit-copy="1">Màn hình app đang tải lại hồ sơ hành vi lao động để xem nhanh điều kiện hợp lệ, yêu cầu và lịch sử chi trả.</p>
                            </div>
                            <div class="app-benefit-balance" data-benefit-balance-card="1">
                                <span class="app-benefit-balance-label" data-benefit-balance-label="1">Số dư hồ sơ lao động</span>
