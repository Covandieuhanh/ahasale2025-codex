...
<head runat="server">
    ...
    <title>AhaSale App UI - Liên hệ</title>
        ...
        <div class="app-shell" data-app-density="compact" data-app-shell="home" data-app-nav-active="home">
            <header class="app-topbar">
                ...
                <div class="app-topbar-row">
                    ...
                    <div class="app-search-pill"><span class="app-search-icon"></span><span class="app-search-placeholder">Liên hệ và trao đổi</span></div>
            ...
            <main class="app-main">
                <section class="app-section" data-app-capability="show_home_inbox">
                    <div class="app-home-panel">
                        <span class="app-home-panel-kicker">Hộp trao đổi</span>
                        <h1 class="app-home-panel-title">Các cuộc trao đổi đang diễn ra giữa bạn và người đăng</h1>
                        <p class="app-home-panel-copy">Luồng trao đổi trong app ưu tiên dữ liệu thật và mở đúng trang xử lý khi bạn cần thao tác sâu hơn.</p>
                    </div>
                </section>
                ...
                <section class="app-section" data-app-capability="show_home_inbox">
                    <div class="app-section-head">
                        <div>
                            <h2 class="app-section-title">Trao đổi gần đây</h2>
                            <p class="app-section-subtitle" data-role="inbox-summary"></p>
                        </div>
                        <a class="app-ghost-btn" href="/app-ui/home/saved.aspx?ui_mode=app">Xem tin lưu</a>
                    </div>
            ...
            <nav class="app-bottom-nav" aria-label="Điều hướng chính" data-app-capability="show_home_inbox">
                ...
                <a class="app-bottom-item is-active" href="/app-ui/home/inbox.aspx?ui_mode=app">
