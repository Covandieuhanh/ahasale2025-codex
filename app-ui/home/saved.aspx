...
<head runat="server">
    ...
    <title>AhaSale App UI - Đã lưu</title>
    ...
    <link rel="stylesheet" href="/app-ui/home/app-home.css" />
</head>
<body class="app-ui app-ui-home">
        ...
        <div class="app-shell" data-app-density="compact" data-app-shell="home" data-app-nav-active="home">
            <header class="app-topbar">
                ...
                <div class="app-topbar-row">
                    ...
                    <div class="app-search-pill"><span class="app-search-icon"></span><span class="app-search-placeholder">Tin đã lưu</span></div>
                ...
                <div class="app-chip-lane" data-role="recent-searches" data-app-capability="show_home_saved"></div>
            </header>

            <main class="app-main">
                <section class="app-section" data-app-capability="show_home_saved">
                    <div class="app-home-panel">
                        <span class="app-home-panel-kicker">Không gian Home</span>
                        <h1 class="app-home-panel-title">Tin bạn đang giữ lại để so sánh và ra quyết định</h1>
                        <p class="app-home-panel-copy">Danh sách này hiển thị nhanh trong app và luôn có điểm mở sang trang quản lý tin đã lưu để xử lý đầy đủ.</p>
                    </div>
                </section>
                ...
                <section class="app-section" data-app-capability="show_home_saved">
                    <div class="app-section-head">
                        <div>
                            <h2 class="app-section-title">Danh sách đã lưu</h2>
                            <p class="app-section-subtitle" data-role="saved-summary"></p>
                        </div>
                        <a class="app-ghost-btn" href="/app-ui/home/saved-manager.aspx?ui_mode=app" data-role="saved-manager-link">Mở quản lý đã lưu</a>
                    </div>
                    <div class="app-feed-grid" data-role="saved-feed"></div>
                </section>
            </main>

            <nav class="app-bottom-nav" aria-label="Điều hướng chính" data-app-capability="show_home_saved">
                <a class="app-bottom-item" href="/app-ui/home/default.aspx">
                    <span class="app-bottom-icon app-bottom-home"></span>
                    <span>Trang chủ</span>
                </a>
                <a class="app-bottom-item is-active" href="/app-ui/home/saved.aspx?ui_mode=app">
                ...
                <a class="app-bottom-item" href="/app-ui/home/inbox.aspx?ui_mode=app">
    ...
    <script src="/app-ui/home/app-home-saved.js?v=20260404a"></script>
</body>
</html>
