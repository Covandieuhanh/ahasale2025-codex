...
<head runat="server">
    ...
    <title>AhaSale App UI - Chi tiết xe</title>
...
<body class="app-ui app-ui-choxe-detail">
        ...
        <div class="app-shell app-shell-choxe" data-app-shell="choxe" data-app-nav-active="search">
            <header class="app-topbar app-topbar-choxe">
                ...
                <div class="app-topbar-row">
                    ...
                    <div class="app-search-pill app-search-pill-choxe"><span class="app-search-icon"></span><span class="app-search-placeholder">Chi tiết xe</span></div>
