...
<head runat="server">
    ...
    <title>AhaSale App UI - Thông báo Aha Tech</title>
...
<body class="app-ui app-ui-dienthoai-maytinh">
    <form id="form1" runat="server">
        <div class="app-shell" data-app-shell="dienthoai-maytinh" data-app-nav-active="home">
            <main class="app-main">
                <section class="app-page-wrap">
                    <article class="app-page-hero">
                        <span class="app-page-kicker">Aha Tech</span>
                        <h1 class="app-page-title">Thông báo Aha Tech</h1>
                        <p class="app-page-copy">Thông báo mới trong không gian điện thoại và máy tính.</p>
                    </article>
