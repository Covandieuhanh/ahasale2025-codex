...
<head runat="server">
    ...
    <title>AhaSale App UI - Dự án bất động sản</title>
            ...
            <main class="app-main">
                <section class="app-page-wrap">
                    <article class="app-page-hero">
                        ...
                        <h1 class="app-page-title">Dự án bất động sản</h1>
                        <p class="app-page-copy">Khám phá các dự án mới và tiến độ cập nhật.</p>
