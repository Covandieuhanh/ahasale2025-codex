...
<head runat="server">
    ...
    <title>AhaSale App UI - Thông báo Aha Land</title>
...
<body class="app-ui app-ui-batdongsan">
    <form id="form1" runat="server">
        <div class="app-shell" data-app-shell="batdongsan" data-app-nav-active="home">
            <main class="app-main">
                <section class="app-page-wrap">
                    <article class="app-page-hero">
                        <span class="app-page-kicker">Aha Land</span>
                        <h1 class="app-page-title">Thông báo Aha Land</h1>
                        <p class="app-page-copy">Thông báo liên quan tin bất động sản và tương tác mới.</p>
                    </article>
