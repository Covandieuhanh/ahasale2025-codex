...
<head runat="server">
    ...
    <title>AhaSale App UI - Tham khảo giá</title>
            ...
            <main class="app-main">
                <section class="app-page-wrap">
                    <article class="app-page-hero">
                        ...
                        <h1 class="app-page-title">Tham khảo giá</h1>
                        <p class="app-page-copy">Theo dõi mức giá tham khảo theo khu vực và phân khúc.</p>
