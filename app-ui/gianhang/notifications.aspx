...
<head runat="server">
    ...
    <title>AhaSale App UI - Thông báo gian hàng</title>
...
<body class="app-ui app-ui-gianhang">
            ...
            <main class="app-main">
                <section class="app-page-wrap">
                    <article class="app-page-hero">
                        ...
                        <h1 class="app-page-title">Thông báo gian hàng</h1>
                        <p class="app-page-copy">Thông báo bán hàng, duyệt tin và tương tác mới.</p>
                    </article>
    ...
    <script src="/app-ui/shared/app-ui-notifications.js?v=20260404c"></script>
</body>
</html>
