...
<head runat="server">
    ...
    <title>AhaSale App UI - Khách hàng gian hàng</title>
...
<body class="app-ui app-ui-gianhang-conversations">
<form id="form1" runat="server">
<div class="app-shell app-shell-gianhang" data-app-shell="gianhang" data-app-nav-active="customers">
...
<div class="app-search-pill app-search-pill-gianhang"><span class="app-search-icon"></span><span class="app-search-placeholder">Khách hàng và lead đang xử lý</span></div>
...
<h1 class="app-results-title">Khách hàng cần xử lý</h1>
<p class="app-results-copy">Lead mới, khách đang hỏi và các cuộc trao đổi cần phản hồi nhanh trong không gian seller.</p>
</div>
</section>
<section class="app-section"><div class="app-conversation-list" data-role="gh-conversation-page"></div></section>
</main>
...
<a class="app-bottom-item" href="/app-ui/gianhang/listing.aspx?ui_mode=app"><span class="app-bottom-icon app-bottom-tag"></span><span>Quản lý tin</span></a>
<a class="app-post-cta app-post-cta-gianhang" href="/app-ui/gianhang/actions.aspx?ui_mode=app" aria-label="Mở công cụ seller">+</a>
<a class="app-bottom-item is-active" href="/app-ui/gianhang/conversations.aspx?ui_mode=app"><span class="app-bottom-icon app-bottom-chat"></span><span>Khách hàng</span></a>
...
<script src="/app-ui/gianhang/app-gianhang-conversations.js?v=20260404a"></script>
</body>
</html>
