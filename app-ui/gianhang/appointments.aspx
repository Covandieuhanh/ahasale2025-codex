...
<head runat="server">
    ...
    <title>AhaSale App UI - Lịch hẹn gian hàng</title>
...
<body class="app-ui app-ui-gianhang">
            ...
            <main class="app-main">
                <section class="app-page-wrap">
                    <article class="app-page-hero">
                        ...
                        <h1 class="app-page-title">Lịch hẹn gian hàng</h1>
                        <p class="app-page-copy">Quản lý lịch hẹn liên quan đơn hàng và khách hàng.</p>
                    ...
                    <section data-role="gh-appointments-runtime"></section>
                </section>
            </main>
        </div>
    </form>
    ...
    <script src="/app-ui/gianhang/app-gianhang-appointments.js?v=20260404b"></script>
</body>
</html>
