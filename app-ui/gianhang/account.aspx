...
<head runat="server">
    ...
    <title>AhaSale App UI - Tài khoản gian hàng</title>
...
<body class="app-ui app-ui-gianhang">
    <form id="form1" runat="server">
        <div class="app-shell" data-app-shell="gianhang" data-app-nav-active="account">
            <main class="app-main">
                <section class="app-page-wrap">
                    <article class="app-page-hero">
                        <span class="app-page-kicker">Aha Shop</span>
                        <h1 class="app-page-title">Tài khoản gian hàng</h1>
                        <p class="app-page-copy">Cài đặt hồ sơ và thông tin vận hành gian hàng.</p>
