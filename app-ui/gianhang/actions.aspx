...
<head runat="server">
    ...
    <title>AhaSale App UI - Công cụ seller gian hàng</title>
...
<body class="app-ui app-ui-gianhang-actions">
...
<div class="app-search-pill app-search-pill-gianhang"><span class="app-search-icon"></span><span class="app-search-placeholder">Công cụ seller và điểm vào quản trị</span></div>
...
<h1 class="app-results-title">Công cụ seller</h1>
<p class="app-results-copy">Các tác vụ vận hành chính: quản lý tin, tạo đơn, chờ thanh toán/chờ trao đổi và chăm sóc khách hàng.</p>
</div>
</section>
<section class="app-section"><div class="app-quick-action-grid" data-role="gh-actions-grid"></div></section>
<section class="app-section"><div class="app-gianhang-priority-strip" data-role="gh-actions-targets"></div></section>
</main>
...
<script src="/app-ui/gianhang/app-gianhang-actions.js?v=20260404e"></script>
</body>
</html>
