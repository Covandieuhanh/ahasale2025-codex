...
<head runat="server">
    ...
    <title>AhaSale App UI - Trạng thái tin gian hàng</title>
...
<body class="app-ui app-ui-gianhang-status">
...
<div class="app-search-pill app-search-pill-gianhang"><span class="app-search-icon"></span><span class="app-search-placeholder">Trạng thái tin và lịch hẹn seller</span></div>
...
<h1 class="app-results-title">Trạng thái tin</h1>
<p class="app-results-copy">Nhìn nhanh tin đang bán, cần sửa, chờ duyệt và cả nhóm việc cần xử lý theo nhịp seller.</p>
</div>
</section>
<section class="app-section"><div class="app-gianhang-priority-strip" data-role="gh-status-summary"></div></section>
<section class="app-section"><div class="app-ops-list" data-role="gh-status-list"></div></section>
</main>
...
<a class="app-bottom-item is-active" href="/app-ui/gianhang/status.aspx?ui_mode=app"><span class="app-bottom-icon app-bottom-tag"></span><span>Trạng thái</span></a>
...
<script src="/app-ui/gianhang/app-gianhang-status.js"></script>
</body>
</html>
