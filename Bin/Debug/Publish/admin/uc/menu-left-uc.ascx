<%@ control language="C#" autoeventwireup="true" inherits="admin_uc_menu_left_uc, App_Web_fu2nbaib" %>
<div class="navview-pane" style="z-index: 6">
    <div class="d-flex flex-align-center bg-navview-left-bc">
        ...
        <div class="app-title h4 text-light m-0 fg-white pl-2" style="line-height: 52px">AHASALE.VN</div>
    </div>
    ...
    <ul class="navview-menu" id="side-menu">
        ...
        <li class="<%=a5 %>">
            <a href="/admin/quan-ly-tai-khoan/default.aspx">
        ...
        <li class="<%=b1 %>">
            ...
            <ul class="navview-menu" data-role="dropdown">
                <li class="item-header">Quản lý module</li>
                <li class="<%=b2 %>">
