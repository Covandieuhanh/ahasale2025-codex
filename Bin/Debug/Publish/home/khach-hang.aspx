<%@ page title="Khách hàng" language="C#" masterpagefile="~/home/MasterPageHome.master" autoeventwireup="true" inherits="home_khach_hang, App_Web_md1cs0my" %>
            ...
            <div class="pos-relative pb-11">
                <div id="menutop-tool-bc" style="position: fixed; top: 52px; width: 100%; z-index: 4">
                    <ul class="h-menu bg-white">
                        ...
                        <li>
                            <a href="/home/lich-su-chuyen-diem.aspx"><small>Lịch sử chuyển điểm</small></a>
                        </li>
