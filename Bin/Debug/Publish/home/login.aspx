<%@ page language="C#" autoeventwireup="true" inherits="home_login, App_Web_ofdqyxp3" %>
...
<link rel="canonical" href="https://bcorn.net" />--%>
    ...
    <style>
        ...
        .bg-login-bcorn1 {
          ...
          .bg-yellow {
      background-color: #f0b90e !important
  }
  ...
  .fg-ahasale1 {
    ...
    <meta property='og:title' content='AHASALE.VN' />
    <meta property='og:image' content='/uploads/img-handler/dd18cf95-f585-41d8-9e6b-02d4988ddd70.jpg' />
                                ...
                                <asp:Panel ID="Panel1" runat="server" DefaultButton="but_login">
                                    ...
                                    <div class="mt-5">
                                        <div style="float: left">
                                            <small>
                                                <asp:LinkButton ID="but_show_form_quenmk" OnClick="but_show_form_quenmk_Click" CssClass="fg-ahasale fg-yellow-hover" runat="server">Quên mật khẩu?</asp:LinkButton>
                                            </small>
                                        </div>
                                        <div style="float: right">

                                            <asp:Button ID="but_login" runat="server" Text="ĐĂNG NHẬP" CssClass="button bg-yellow fg-black bg-amber-hover ml-2 " OnClick="but_login_Click" />
