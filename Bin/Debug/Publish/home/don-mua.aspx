<%@ page title="Đơn mua" language="C#" masterpagefile="~/home/MasterPageHome.master" autoeventwireup="true" inherits="home_don_mua, App_Web_md1cs0my" %>
                    ...
                    <div style='top: 0; left: 0; margin: 0 auto; max-width: 656px; opacity: 1;'>
                        <div class="bg-white border bd-transparent pl-4 pl-8-md pr-8-md pr-4" style="padding-top: 52px">
                            ...
                            <div class="mt-6 mb-20 text-right">
                                <asp:Button ID="but_danhanhang" OnClick="but_danhanhang_Click" runat="server" Text="Xác nhận đã nhận hàng" CssClass="button dark small rounded" />
                            ...
                            <table class="bcorn-fix-title-table">
                                <thead>
                                    <tr class="">
                                        ...
                                        <th style="min-width: 100px;">Tên Shop</th>
                                        <th style="min-width: 90px;">Trao đổi</th>
                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server">
                                        <ItemTemplate>
                                            ...
                                            <tr>
                                                ...
                                                <td><%# Eval("TenShop") %></td>
                                                <td class="text-right"><%#Eval("tongtien","{0:#,##0}") %><img src="/uploads/images/dong-a.png" style="width: 20px!important" class="pl-1" /></td>
                                                <td>
