                                    ...
                                    <asp:Panel ID="pn_reset_security_actions" runat="server" CssClass="mt-4 p-3 border bd-default rounded" Visible="false">
                                        ...
                                        <asp:Panel ID="pn_reset_home_credentials" runat="server" CssClass="mt-3" Visible="false">
                                            <div class="mt-2">
                                                ...
                                                <div class="d-flex flex-wrap align-items-center">
                                                    <asp:TextBox ID="txt_reset_home_password" runat="server" data-role="input" placeholder="Nhập mật khẩu tạm thời mới"></asp:TextBox>
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <div class="d-flex flex-wrap align-items-center">
                                                    <asp:TextBox ID="txt_reset_home_pin" runat="server" MaxLength="4" data-role="input" placeholder="4 chữ số"></asp:TextBox>
                                        ...
                                        <asp:Panel ID="pn_reset_shop_credentials" runat="server" CssClass="mt-3" Visible="false">
                                            <div class="mt-2">
                                                ...
                                                <div class="d-flex flex-wrap align-items-center">
                                                    <asp:TextBox ID="txt_reset_shop_password" runat="server" data-role="input" placeholder="Nhập mật khẩu tạm thời mới"></asp:TextBox>
