<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Header_uc.ascx.cs" Inherits="Uc_Xe_Header_uc" %>
...
<style>
    ...
    .site-header .guest-avatar-fallback {
        width: 28px;
        height: 28px;
        margin: auto;
        border-radius: 999px;
    ...
    .site-header .guest-avatar-fallback i {
        font-size: 18px;
        line-height: 1;
    }
            ...
            <div class="navbar-nav flex-row align-items-center gap-2 header-right-nav">
                ...
                <asp:PlaceHolder ID="phTopDesktopAccount" runat="server" Visible="true">
                    <button type="button"
                        ...
                        <% } else { %>
                        <span class="guest-avatar-fallback" aria-hidden="true"><i class="ti ti-user"></i></span>
                        <% } %>
                    </button>
                </asp:PlaceHolder>
            </div>
