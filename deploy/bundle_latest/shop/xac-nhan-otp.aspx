<%@ Page Title="Xác nhận OTP" Language="C#" MasterPageFile="~/MasterPage/Tabler/TablerHome.master"
    AutoEventWireup="true" CodeFile="xac-nhan-otp.aspx.cs" Inherits="shop_xac_nhan_otp" %>

<asp:Content ID="cHeadTruoc" ContentPlaceHolderID="head_truoc" runat="Server">
    <style>
        .page.page-center .btn-success {
            background: #ee4d2d;
            border-color: #ee4d2d;
        }

        .page.page-center .btn-success:hover {
            background: #d94327;
            border-color: #d94327;
        }

        .page.page-center .btn-success:focus {
                ...
                <div class="card-body">
                    ...
                    <asp:Panel ID="pn_form" runat="server" Visible="false">
                        ...
                        <div class="mb-2 text-secondary">
                            OTP đã được tạo cho <strong><asp:Literal ID="lit_email" runat="server"></asp:Literal></strong>
                        </div>
