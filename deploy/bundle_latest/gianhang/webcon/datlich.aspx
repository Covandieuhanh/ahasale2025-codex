<%@ Page Title="Đặt lịch hẹn" Language="C#" MasterPageFile="~/gianhang/webcon/mp-webcon.master" AutoEventWireup="true" CodeFile="datlich.aspx.cs" Inherits="chitiettintuc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="Server">
    ...
    <div class="container-fluid pt-10 pb-20" <%--style="background: rgb(0,61,0); background: radial-gradient(circle, rgba(0,61,0,1) 0%, rgba(0,214,0,1) 0%, rgba(0,138,0,1) 100%);"--%>>
        <div class="container">
                ...
                <div class="example bg-light p-4 mt-6">
                    <div class="row">
                        <div class="cell-lg-6 mt-3 pr-2-lg">
                            ...
                            <asp:TextBox ID="txt_ngay" runat="server" MaxLength="10" data-role="calendar-picker" data-outside="true" data-dialog-mode="true" data-week-start="1" data-locale="vi-VN" data-format="DD/MM/YYYY" data-input-format="DD/MM/YYYY" data-clear-button="true"></asp:TextBox>
                        ...
                        <div class="cell-lg-6 mt-3 pr-2-lg">
                            ...
                            <span class="ani-float place-left pl-2">
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="!" ForeColor="#CE352C" ControlToValidate="DropDownList1" InitialValue="" ValidationGroup="val_dathang"></asp:RequiredFieldValidator>
                            </span>
                            <div>
                        ...
                        <div class="cell-lg-12 text-center mt-8 mb-6">
                            <asp:Button ID="but_dathang" runat="server" CssClass="button info large primary" Text="ĐẶT LỊCH HẸN" ValidationGroup="val_dathang" OnClick="but_dathang_Click" />
                        </div>
                    </div>
                </div>
            </asp:Panel>
