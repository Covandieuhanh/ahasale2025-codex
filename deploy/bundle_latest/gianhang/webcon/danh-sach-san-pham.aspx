<%@ Page Title="" Language="C#" MasterPageFile="~/gianhang/webcon/mp-webcon.master" AutoEventWireup="true" CodeFile="danh-sach-san-pham.aspx.cs" Inherits="danh_sach_bai_viet" %>
            ...
            <div class="container-fluid pt-6 pt-10-lg ">
                <div class="container">
                    <div class="pl-3-lg pl-0 pr-3-lg pr-0">
                        ...
                        <div class="pt-6">
                            <asp:TextBox ID="txt_search" runat="server" data-role="input" data-prepend="<span class='mif mif-search'></span>" placeholder="Tìm kiếm sản phẩm" OnTextChanged="txt_search_TextChanged" AutoPostBack="true"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row">
                        <asp:Repeater ID="Repeater1" runat="server">
                            <ItemTemplate>
                                <div class="cell-lg-4 pl-3-lg pl-0 pr-3-lg pr-0 mt-10">
                                    <div class="h-100">
                                        <div>
                                            <a class="fg-black fg-green-hover" href="/gianhang/webcon/chi-tiet-san-pham.aspx?tkchinhanh=<%=tkchinhanh %>&idbv=<%#Eval("id") %>">
                                                <img src="<%#Eval("image") %>" /></a>
                                        </div>
                                        <div class=" border bd-default border-top-none p-3">
                                            <div class=" fw-600 ellipsis-2">
                                                <a class="fg-black fg-green-hover" href="/gianhang/webcon/chi-tiet-san-pham.aspx?tkchinhanh=<%=tkchinhanh %>&idbv=<%#Eval("id") %>"><%#Eval("name") %></a>
                                            </div>
                                            ...
                                            <div class="text-right">
                                                ...
                                                <a class="button secondary rounded" href="/gianhang/webcon/giohang.aspx?tkchinhanh=<%=tkchinhanh %>&id=<%#Eval("id").ToString() %>">Thêm vào giỏ</a>
                                                <a class="button bg-emerald bg-darkEmerald-hover fg-white rounded" href="/gianhang/webcon/giohang.aspx?tkchinhanh=<%=tkchinhanh %>&id=<%#Eval("id").ToString() %>&dh=ok">Đặt hàng</a>
                                            </div>
                                        </div>
                                    </div>
