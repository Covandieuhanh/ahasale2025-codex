<%@ Page Title="" Language="C#" MasterPageFile="~/gianhang/webcon/mp-webcon.master" AutoEventWireup="true" CodeFile="chi-tiet-bai-viet.aspx.cs" Inherits="danh_sach_bai_viet" %>
                    ...
                    <div style="border-top: 1px solid #eeeeee" class="mt-9">
                        ...
                        <asp:Repeater ID="Repeater2" runat="server">
                            <ItemTemplate>
                                <div class="row mt-9">
                                    <div class="cell-lg-4">
                                        <a href="/gianhang/webcon/chi-tiet-bai-viet.aspx?tkchinhanh=<%=tkchinhanh %>&idbv=<%#Eval("id") %>">
                                            <img src="<%#Eval("image") %>" class="radius-bc-4" /></a>
                                    </div>
                                    <div class="cell-lg-8 pl-3-lg">
                                        <div class="fw-600 ellipsis-2 mt-0-lg mt-2">
                                            <a class="fg-black fg-emerald-hover" href="/gianhang/webcon/chi-tiet-bai-viet.aspx?tkchinhanh=<%=tkchinhanh %>&idbv=<%#Eval("id") %>"><%#Eval("name") %></a>
                                        </div>
