<%@ Page Title="Giỏ hàng của bạn" Language="C#" MasterPageFile="~/gianhang/mp-home.master" AutoEventWireup="true" CodeFile="giohang.aspx.cs" Inherits="chitiettintuc" %>
                        ...
                        <tbody>
                            <asp:Repeater ID="Repeater1" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <a href='<%# AhaShineHomeRoutes_cl.RemoveCartItemUrl + "?id=" + Eval("ID").ToString() %>' data-role="hint" data-hint-text="Xóa" data-hint-position="top">
