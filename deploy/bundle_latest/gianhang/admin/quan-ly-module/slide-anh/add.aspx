<%@ Page Title="Thêm ảnh vào slider" Language="C#" MasterPageFile="~/gianhang/admin/mp-admin.master" AutoEventWireup="true" CodeFile="add.aspx.cs" Inherits="admin_slider_Default" %>
            ...
            <div class="cell-lg-6">
                <asp:Panel ID="Panel1" runat="server" DefaultButton="but_add">
                     <div class="mt-3">
                            ...
                            <span style="cursor: pointer" class="mif mif-question ml-1" data-role="popover" data-popover-text="<small>Kích thước chuẩn: 1920x822 pixel</small>" data-popover-hide="8000" data-close-button="false" data-popover-position="right" data-popover-trigger="click" data-cls-popover="drop-shadow"></span>
                        ...
                        <div class="mt-3">
                            ...
                            <asp:TextBox ID="txt_link1" runat="server" data-role="input" placeholder="Ví dụ: "></asp:TextBox>
                        </div>
                        <div class="mt-3">
                        ...
                        <div class="text-right-lg text-center mt-10">
                            <asp:Button OnClientClick="Metro.activity.open({type:'cycle',overlayClickClose:false})" ID="but_add" runat="server" Text="THÊM ẢNH" CssClass="button success" OnClick="but_add_Click" />
                        </div>
