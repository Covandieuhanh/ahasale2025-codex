                ...
                <div>
                    ...
                    <div class="row">
                        <div class="cell-md-6 order-2 order-md-1 mt-0">
                            <asp:TextBox ID="txt_search" runat="server" data-role="input" data-prepend="<span class='mif mif-search'></span>" placeholder="Tìm kiếm vật tư theo tên" OnTextChanged="txt_search_TextChanged" AutoPostBack="true"></asp:TextBox>
