<%@ Page Title="Quản lý tài khoản" Language="C#" MasterPageFile="~/gianhang/admin/mp-admin.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="badmin_quan_ly_menu_Default" %>
                ...
                <asp:Panel ID="Panel2" runat="server" DefaultButton="Button4">
                    <div class="mt-3">
                        ...
                        <asp:CheckBoxList ID="check_list_excel" runat="server">
                            <asp:ListItem Text="Tên tài khoản" Value="taikhoan"></asp:ListItem>
                        </asp:CheckBoxList>
                    </div>
                    ...
                    <div class="cell-md-6 order-1 order-md-2 mt-0">
                        ...
                        <div class="place-right">
                            <ul class="h-menu">
                                ...
                                <li data-role="hint" data-hint-position="top" data-hint-text="Khóa các mục đã chọn">
                                    <asp:ImageButton ID="but_khoa" runat="server" ImageUrl="~/uploads/images/icon-button/but-lock.png" OnClick="but_khoa_Click" /></li>
                                <li class="bd-gray border bd-default mt-1" style="height: 28px"></li>
                                <li data-role="hint" data-hint-position="top" data-hint-text="Mở khóa các mục đã chọn">
                                    <asp:ImageButton ID="but_mokhoa" runat="server" ImageUrl="~/uploads/images/icon-button/but-unlock.png" OnClick="but_mokhoa_Click" /></li>
                                <li class="bd-gray border bd-default mt-1" style="height: 28px"></li>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <td class="checkbox-table">
                                                <input class="mt-1" type="checkbox" onkeypress="if (event.keyCode==13) return false;" data-role="checkbox" data-style="2" name="check_<%#Eval("taikhoan").ToString() %>">
                                            ...
                                            <td>
                                                <a href="/gianhang/admin/quan-ly-tai-khoan/tai-khoan.aspx?user=<%#Eval("taikhoan").ToString() %>" data-role="hint" data-hint-position="top" data-hint-text="Xem chi tiết">
                                            ...
                                            <td>
                                                <asp:PlaceHolder ID="PlaceHolder14" runat="server" Visible='<%#Eval("trangthai").ToString()=="Đang hoạt động" %>'>
                                                    <a class="fg-black fg-blue-hover" href="/gianhang/admin/quan-ly-tai-khoan/tai-khoan.aspx?user=<%#Eval("taikhoan").ToString() %>">
                                                        <span><small><%#Eval("taikhoan") %></small></span>
                                                        <div><%#Eval("hoten") %></div>
                                                    </a>
                                                </asp:PlaceHolder>
                                                <asp:PlaceHolder ID="PlaceHolder1" runat="server" Visible='<%#Eval("trangthai").ToString()=="Đã bị khóa" %>'>
                                                    <a class="fg-red fg-darkRed-hover" href="/gianhang/admin/quan-ly-tai-khoan/tai-khoan.aspx?user=<%#Eval("taikhoan").ToString() %>">
                                                        <span class="fg-red"><small><%#Eval("taikhoan") %></small></span>
                                                        <div class="fg-red"><%#Eval("hoten") %></div></asp:PlaceHolder>
                                                </a>
                                            </td>
                                            <td>
                                              
                                                <div><%#Eval("tennganh").ToString()%></div>
