...
public partial class danh_sach_bai_viet : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("/gianhang/giohang.aspx?id=" + idbv + "&sl=" + txt_soluong_dv.Text.Trim());
    }
    protected void but_dathang_Click(object sender, EventArgs e)
    {
        Response.Redirect("/gianhang/giohang.aspx?id=" + idbv + "&sl=" + txt_soluong_dv.Text.Trim() + "&dh=ok");
    }
}
