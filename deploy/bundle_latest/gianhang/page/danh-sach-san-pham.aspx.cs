...
public partial class danh_sach_bai_viet : System.Web.UI.Page
{
    ...
    private string ResolveRequestedMenuId()
    {
        ...
        return GianHangStorefront_cl.ResolveDefaultMenuId("dssp");
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Session["notifi_home"] = thongbao_class.metro_dialog_onload("Thong bao", "Danh muc san pham khong hop le.", "false", "false", "OK", "alert", "");
            Response.Redirect(AhaShineHomeRoutes_cl.HomeUrl);
            return;
        }

        var menu = mn_cl.return_object(idmn);
        if (menu.phanloai != "dssp")
        {
            Session["notifi_home"] = thongbao_class.metro_dialog_onload("Thong bao", "Danh muc san pham khong hop le.", "false", "false", "OK", "alert", "");
            Response.Redirect(AhaShineHomeRoutes_cl.HomeUrl);
            return;
