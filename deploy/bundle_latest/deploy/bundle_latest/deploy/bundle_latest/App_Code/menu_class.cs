...
public class menu_class
{
    ...
    {
        var q = db.web_menu_tables.Where(p => p.id.ToString() == _id && p.id_chinhanh == System.Web.HttpContext.Current.Session["chinhanh"].ToString());
        if (q.Count() != 0)
            return true;
        return false;
    }
    ...
    {
        var q = db.web_menu_tables.Where(p => p.name.ToLower() == _name.ToLower() && p.id_chinhanh == System.Web.HttpContext.Current.Session["chinhanh"].ToString());
        if (q.Count() != 0)
            return true;
        return false;
    }
    ...
    {
        var q = db.web_menu_tables.Single(p => p.id.ToString() == _id && p.id_chinhanh == System.Web.HttpContext.Current.Session["chinhanh"].ToString());
        return q;
    }
    #endregion    
    ...
    {
        var q = db.web_menu_tables.Where(p => p.id_chinhanh == System.Web.HttpContext.Current.Session["chinhanh"].ToString()).ToList();
        return q;
    }
    #endregion
    ...
    {
        var q = db.web_menu_tables.Where(p => p.id_parent.ToString() == _id_parent && p.id_chinhanh == System.Web.HttpContext.Current.Session["chinhanh"].ToString()).ToList();
        return q;
    }
    #endregion
    ...
    {
        var q = db.web_menu_tables.Where(p => p.id_parent.ToString() == _id && p.bin == false && p.id_chinhanh == System.Web.HttpContext.Current.Session["chinhanh"].ToString());
        if (q.Count() != 0)
            return true;
        return false;
    }
    ...
    public string get_idmn_cap1(string _idmn)//hàm lấy id cấp 1
    {
        int _id_level;
        idmn_cap1 = _idmn;
        var q1 = db.web_menu_tables.Where(p => p.id.ToString() == _idmn && p.id_chinhanh == System.Web.HttpContext.Current.Session["chinhanh"].ToString());
        if (q1.Count() != 0)
        {
            ...
            else
            {
                ...
                {
                    var q2 = db.web_menu_tables.Where(p => p.id.ToString() == idmn_cap1 && p.id_chinhanh == System.Web.HttpContext.Current.Session["chinhanh"].ToString());
    ...
    {
        var q = db.web_menu_tables.Where(p => p.id_parent.ToString() == _id && p.id_chinhanh == System.Web.HttpContext.Current.Session["chinhanh"].ToString());
        if (q.Count() != 0)
            return true;
        return false;
    }
