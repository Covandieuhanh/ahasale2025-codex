<%@ Page Title="Hồ sơ chỉ số gắn kết" Language="C#" MasterPageFile="~/MasterPage/Tabler/TablerHome.master"
    AutoEventWireup="true" CodeFile="lich-su-quyen-gan-ket.aspx.cs" Inherits="home_lich_su_quyen_gan_ket" %>
            ...
            <div class="page-header d-print-none">
                <div class="container-xl">
                    <div class="row g-2 align-items-center">
                        <div class="col">
                            <h2 class="page-title">Hồ sơ chỉ số gắn kết</h2>
                        </div>
                ...
                <div class="container-xl">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <h3 class="card-title">3 hành vi trong hồ sơ chỉ số gắn kết</h3>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-vcenter card-table">
                                <thead>
