<%@ Page Title="Hồ sơ hành vi lao động" Language="C#" MasterPageFile="~/MasterPage/Tabler/TablerHome.master"
    AutoEventWireup="true" CodeFile="lich-su-quyen-lao-dong.aspx.cs" Inherits="home_lich_su_quyen_lao_dong" %>
            ...
            <div class="page-header d-print-none">
                <div class="container-xl">
                    <div class="row g-2 align-items-center">
                        <div class="col">
                            <h2 class="page-title">Hồ sơ hành vi lao động</h2>
                        </div>
                ...
                <div class="container-xl">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <h3 class="card-title">3 hành vi trong hồ sơ hành vi lao động</h3>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-vcenter card-table">
                                <thead>
