...
public partial class home_lich_su_quyen_gan_ket : System.Web.UI.Page
{
    private const int ProfileCode = HanhViGhiNhanHoSo_cl.Profile_GanKet;
    private const int LoaiHoSoVi = 4;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            using (dbDataContext db = new dbDataContext())
            {
                ...
                {
                    Session["thongbao_home"] = "Bạn cần đạt tầng đồng hành hệ sinh thái để xem hồ sơ chỉ số gắn kết.";
    ...
    private void LoadTongHopHanhViVaYeuCau(dbDataContext db, string tk)
    {
        ...
        lb_moc_hople.Text =
            ...
            + " Điểm đã duyệt của hồ sơ này được ghi nhận vào dữ liệu chờ chi trả thưởng, không cộng trực tiếp vào Số dư điểm trong hồ sơ.";
