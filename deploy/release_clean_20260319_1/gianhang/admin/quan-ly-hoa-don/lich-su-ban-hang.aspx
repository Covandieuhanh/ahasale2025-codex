<%@ Page Title="Lịch sử bán hàng" Language="C#" MasterPageFile="~/gianhang/admin/mp-admin.master" AutoEventWireup="true" CodeFile="lich-su-ban-hang.aspx.cs" Inherits="admin_quan_ly_hoa_don_lich_su_ban_hang" %>
                    ...
                    <div class="">
                        <div id="_data">
                            ...
                            <div class="mt-3">
                                ...
                                <asp:DropDownList ID="ddl_nhanvien_chotsale" runat="server" data-role="select" data-filter="true"></asp:DropDownList>
                            </div>
                            <div class="mt-3">
                                <label class="fw-600">Nhân viên làm dịch vụ</label>
                                <asp:DropDownList ID="ddl_nhanvien_lamdichvu" runat="server" data-role="select" data-filter="true"></asp:DropDownList>
                            </div>
                ...
                <asp:Panel ID="Panel4" runat="server" DefaultButton="Button5">
                    ...
                    <div class="mt-3">
                        ...
                        <asp:CheckBoxList ID="check_list_excel" runat="server" CssClass="checklist_excel">
                            <asp:ListItem Text="Ngày bán" Value="ngaytao"></asp:ListItem>
                            <asp:ListItem Text="Mã đơn" Value="id_hoadon"></asp:ListItem>
                            <asp:ListItem Text="Tên khách hàng" Value="tenkhachhang"></asp:ListItem>
                            <asp:ListItem Text="Số điện thoại" Value="sdt"></asp:ListItem>
                            <asp:ListItem Text="Mặt hàng" Value="tendvsp"></asp:ListItem>
                            <asp:ListItem Text="Dịch vụ/Sản phẩm" Value="kyhieu"></asp:ListItem>
                            <asp:ListItem Text="Sử dụng thẻ DV" Value="id_thedichvu"></asp:ListItem>
                            <asp:ListItem Text="Giá bán" Value="gia"></asp:ListItem>
                            <asp:ListItem Text="Số lượng bán" Value="soluong"></asp:ListItem>
                            <asp:ListItem Text="Thành tiền" Value="thanhtien"></asp:ListItem>
                            <asp:ListItem Text="Chiết khấu" Value="chietkhau"></asp:ListItem>
                            <asp:ListItem Text="Sau chiết khấu" Value="sauck"></asp:ListItem>
                            <asp:ListItem Text="Tên người chốt" Value="tennguoichot_xuat_excel"></asp:ListItem>
                            <asp:ListItem Text="Phần trăm chốt" Value="phantramchot"></asp:ListItem>
                            <asp:ListItem Text="Tổng tiền chốt" Value="tongtien_chot"></asp:ListItem>
                            <asp:ListItem Text="Tên người làm" Value="tennguoilam_xuat_excel"></asp:ListItem>
                            <asp:ListItem Text="Phần trăm làm" Value="phantramlam"></asp:ListItem>
                            <asp:ListItem Text="Tổng tiền làm" Value="tongtien_lam"></asp:ListItem>
                        </asp:CheckBoxList>
                    </div>
    ...
    <div id="main-content" class="mb-10">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <ContentTemplate>
                ...
                <div class="row<%--mt-0-lg-minus mt-12-minus--%>">
                        ...
                        <table class="table row-hover table-border cell-border compact normal-lg <%--striped--%> <%--compact normal-lg--%>">
                            <thead>
                                <tr style="background-color: #ecf0f5">
                                    ...
                                    <td class="text-bold" style="width: 1px;">Ngày bán</td>
                                        ...
                                        <tr>
                                            ...
                                            <td class=" text-center">
                                                <a data-role="hint" data-hint-position="top" data-hint-text="Xem hóa đơn" href="/gianhang/admin/quan-ly-hoa-don/chi-tiet.aspx?id=<%#Eval("id_hoadon").ToString() %>">
                                                    <b><%#Eval("id_hoadon").ToString() %></b></a>
                                            </td>

                                            <td><%#Eval("tenkhachhang").ToString() %>
                                                <div><small>
                                                    <a class="fg-black" data-role="hint" data-hint-position="top" data-hint-text="Nhấn để gọi" href="tel:<%#Eval("sdt").ToString() %>"><%#Eval("sdt").ToString() %></a>
                                                     </small></div>
                                            </td>
                            ...
                            <tfoot>
                                <tr class="">
                                    <td colspan="5" class="text-right text-leader text-bold fg-red text-size-20">Tổng cộng</td>
                                    <td class="text-right text-bold fg-red"><%=tongsoluong.ToString("#,##0") %></td>
                                    <td class="text-right text-bold fg-red"><%=tongtien.ToString("#,##0") %></td>
                                    <td class="text-right text-bold fg-red"><%=tongtien_ck.ToString("#,##0") %></td>
                                      <td class="text-right text-bold fg-red"><%=tong_sauck.ToString("#,##0") %></td>

                                    <td class="text-right text-bold fg-red"><%=tongtien_chot.ToString("#,##0") %></td>
                                    <td class="text-right text-bold fg-red"><%=tongtien_lam.ToString("#,##0") %></td>
