            ...
            <div class="row">
                <div class="cell-lg-8 pr-4-lg bd-style-bc1">
                    ...
                    <div class="fg-emerald mt-4 text-bold">
                        <span class="mif mif-3x mif-dollar2 pr-1"></span>GIÁ SẢN PHẨM: <%=gia %> VNĐ                 
                    </div>
                    ...
                    <div style="border-top: 1px solid #eeeeee" class="mt-9">
                        ...
                        <asp:Repeater ID="Repeater2" runat="server">
                            <ItemTemplate>
                                <div class="row mt-9">
                                    <div class="cell-lg-4">
                                        <a href="/gianhang/page/chi-tiet-san-pham.aspx?idbv=<%#Eval("id") %>">
                                            <img src="<%#Eval("image") %>" class="radius-bc-4" /></a>
                                    </div>
                                    <div class="cell-lg-8 pl-3-lg">
                                        <div class="fw-600 ellipsis-2 mt-0-lg mt-2">
                                            <a class="fg-black fg-emerald-hover" href="/gianhang/page/chi-tiet-san-pham.aspx?idbv=<%#Eval("id") %>"><%#Eval("name") %></a>
                                        </div>
