<%@ Page Language="C#" AutoEventWireup="true" CodeFile="2.aspx.cs" Inherits="dt" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>NGÀY HỘI LÀM ĐẸP</title>
            ...
            <ContentTemplate>
                <div style="max-width: 400px; margin: 0 auto" class="mt-0 mb-6 p-5">
                    <div class="text-center mb-6 mt-10">
                        <div class="fg-white">NGÀY HỘI LÀM ĐẸP</div>
                        <div style="font-size: 20px" class="text-bold fg-white">CHỮA LÀNH BẰNG ỨNG DỤNG<br />CÔNG NGHỆ TẦN SÓNG THZ & PEMF</div>
                        <div style="display: flex; justify-content: center; align-items: center; ">
                            <img src="/GETDATA/oly.png" width="84" />
                            <img src="/GETDATA/ahashine1.png" width="68" class="ml-4 mt-4-minus" />
                        </div>


                        <div style="font-size: 15px" class="text-bold fg-white mt-2-minus">CLB CHĂM SÓC SỨC KHỎE AHA SHINE</div>
                    ...
                    <asp:Panel ID="Panel1" runat="server" DefaultButton="Button1">
                        ...
                        <div class="fg-white text-center mt-3"><small>Tham gia nhóm để nhận thưởng</small></div>
                    </asp:Panel>
                </div>
            </ContentTemplate>
        </asp:UpdatePanel>
